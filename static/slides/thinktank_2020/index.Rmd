...
background-image: url("./img/Fig1_Strata_Panel.PNG")
background-size: contain
...
---
background-image: url("./img/map-EEZ.png")
background-size: contain
---
background-image: url("./img/map-EEZ_growth.png")
background-size: contain
???
...
---
background-image: url("./img/map-EEZ_strata_lab.png")
background-size: contain
--
...
---
background-image: url("./img/Fig2_OM_indices.png")
background-size: contain
# .small[Data Inputs: Surveys]
---
background-image: url("./img/OMGrowthCurves_50N.PNG")
background-size: contain
...
---
background-image: url("./img/Mat_fit6.PNG")
background-size: contain
