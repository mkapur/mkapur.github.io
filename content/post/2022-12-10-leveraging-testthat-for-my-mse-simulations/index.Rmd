...
```{r, echo = F}
knitr::include_graphics('C:/users/mkapur/dropbox/other projects/mkapur.github.io/content/post/2022-12-10-leveraging-testthat-for-my-mse-simulations/mse_schematic.jpg')
```
