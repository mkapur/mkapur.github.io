...
ggplot(iris, aes(x = Petal.Length, y = Petal.Width, fill = Species)) + 
  ...
  theme_bw()
```
![](../../static/img/ggthemes/theme_bw.png)
# 3 theme_minimal()
...
![](../../static/img/ggthemes/theme_sleek.png)


# 5hrbrthemes::theme_modern_rc()
...
p1 <- ggplot(iris, aes(x = Petal.Length, y = Petal.Width, fill = Species)) + 
  ...
  theme_ft_rc()
```
![](../../static/img/ggthemes/hrbrthemes.png)
...
```
![](../../static/img/ggthemes/solarized.png)
...
![](../../static/img/ggthemes/theme_solarized_mk.png)
...
![](../../static/img/ggthemes/theme_mk.png)
...
![](../../static/img/ggthemes/starfish_mk.png)